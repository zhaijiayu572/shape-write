const accessor = require('./dbf-write')
 ...
 * @param meta:Array
 */
module.exports.structure = function (data, fileName, encoding = 'utf-8') {
  ...
  return accessor.write(field_meta, valBody, fileName, encoding)
}
